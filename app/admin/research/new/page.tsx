  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        alert(result.message || 'Failed to create research entry')
        setLoading(false)
      }
    } catch (error) {
      console.error('Failed to create research:', error)
      alert('Failed to create research entry')
      setLoading(false)
    }
  }
    ...
    <AdminLayout>
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Add Raw Research Entry</h1>
            <p className="text-gray-500 mt-1">Save supplier and material research information</p>
          </div>
        </div>
